                ...
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-end z-20">
                    <div className="bg-white rounded-t-lg p-5 w-full max-w-sm relative mb-48 shadow-lg">
                        ...
                        <div className="flex justify-around mb-3">
                            <button
                                className="bg-blue-600 text-white py-2 px-3 rounded-lg shadow-sm focus:outline-none"
                                onClick={openDepositModal}
                            >
                                Dépôt
                            </button>
                            <button
                                className="bg-green-600 text-white py-2 px-3 rounded-lg shadow-sm focus:outline-none"
